...
export default function BottomActionBar({ leftLabel, leftValue, center, right }: Props) {
  return (
    <div className="safe-bottom sticky bottom-0 z-30 border-t border-white/10 bg-[#1a1a2e]/95 backdrop-blur">
      <div className="flex items-center justify-between gap-3 px-4 py-3">
        <div className="flex items-baseline gap-2 min-w-[110px]">
          ...
          {leftValue && (
            <span className="text-2xl font-bold text-[#d4af37] tabular-nums tracking-tight">{leftValue}</span>
          )}
        </div>
